...
Сценарий: Создание документа Поступления товаров чтобы поставитьтовар на учет
...
*Проверка заполнения табличной части
	Тогда таблица "Товары" содержит строки:
		...
		| '1' | 'Bosch1234' | '2 500,00' | 'Ч-0001'  | '25,00'      | '50 000,00' |
